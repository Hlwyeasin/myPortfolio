...
import clenignimg from  "../../assets/cleaningproject.png"
            ...
            <div className="bg-white dark:bg-purple-700 rounded-lg shadow-xl overflow-hidden transform transition duration-500 hover:scale-105">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-700 dark:text-gray-300 text-base mb-4">
                  ...
                  custom backend. Features include user authentication, product
                  listings, shopping cart, and order management.
                </p>
                ...
                <div className="flex justify-end space-x-4">
                  <a
                    href="https://agenc-full.vercel.app/"
                    target="_blank"
                  ...
                  >
                    ...
                    >
                      <path
                        fillRule="evenodd"
                        d="M12.395 2.175a1.5 1.5 0 00-2.79 0L7.5 7.155A1.5 1.5 0 008.895 9h2.21A1.5 1.5 0 0013.5 7.155l-2.105-4.98zM6.5 10A1.5 1.5 0 005 11.5v4A1.5 1.5 0 006.5 17h7A1.5 1.5 0 0015 15.5v-4A1.5 1.5 0 0013.5 10h-7zm2 1h3a.5.5 0 01.5.5v1.5a.5.5 0 01-.5.5h-3a.5.5 0 01-.5-.5v-1.5a.5.5 0 01.5-.5z"
                        clipRule="evenodd"
                      />
                    </svg>
                    Code
            ...
            <div className="bg-white dark:bg-purple-700 rounded-lg shadow-xl overflow-hidden transform transition duration-500 hover:scale-105">
              <img
                ...
                onError={(e) => {
                  ...
                  e.target.src =
                    "https://placehold.co/600x400/528340/ffffff?text=Image+Error";
                }}
              />
              <div className="p-6">
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">
                ...
                <p className="text-gray-700 dark:text-gray-300 text-base mb-4">
                  ...
                  updates. Users can create, assign, and track tasks, utilizing
                  WebSockets for instant synchronization.
                </p>
                <div className="flex flex-wrap gap-2 mb-4">
                ...
                <div className="flex justify-end space-x-4">
                  <a
                    href="https://cleaning-project-zeta.vercel.app/"
                    target="_blank"
            ...
            <div className="bg-white dark:bg-purple-700 rounded-lg shadow-xl overflow-hidden transform transition duration-500 hover:scale-105">
              <img
                ...
                onError={(e) => {
                  e.target.onerror = null;
                  e.target.src =
                    "https://placehold.co/600x400/6A5ACD/ffffff?text=Image+Error";
                }}
              />
              <div className="p-6">
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">
             Cleaning project
                ...
                <p className="text-gray-700 dark:text-gray-300 text-base mb-4">
                  ...
                  conditions and forecasts using data from a third-party API.
                  Includes location search and unit conversion.
                </p>
                <div className="flex flex-wrap gap-2 mb-4">
                  <span className="bg-orange-100 text-orange-800 text-xs font-semibold px-2.5 py-0.5 rounded-full dark:bg-orange-900 dark:text-orange-300">
                    HTML5
                  </span>
                  <span className="bg-cyan-100 text-cyan-800 text-xs font-semibold px-2.5 py-0.5 rounded-full dark:bg-cyan-900 dark:text-cyan-300">
                    CSS3
                  </span>
                  <span className="bg-lime-100 text-lime-800 text-xs font-semibold px-2.5 py-0.5 rounded-full dark:bg-lime-900 dark:text-lime-300">
                    JavaScript
                  </span>
                  <span className="bg-indigo-100 text-indigo-800 text-xs font-semibold px-2.5 py-0.5 rounded-full dark:bg-indigo-900 dark:text-indigo-300">
                    API Integration
